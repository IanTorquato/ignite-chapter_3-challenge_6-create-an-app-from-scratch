...
const mockedQueryReturn = {
  results: [{ uid: 'como-utilizar-hooks' }, { uid: 'criando-um-app-cra-do-zero' }],
};
      ...
      },
      {
        body: [
          ...
          },
          {
            ...
            spans: [{ start: 49, end: 56, type: 'strong' }],
          },
        ],
...
describe('Post', () => {
  beforeAll(() => {
    ...
    mockedPrismic.mockReturnValue({
      getByUID: () => Promise.resolve(mockedGetByUIDReturn),
  ...
  it('should be able to render loading message if fallback', () => {
    mockedUseRouter.mockReturnValueOnce({ isFallback: true });
